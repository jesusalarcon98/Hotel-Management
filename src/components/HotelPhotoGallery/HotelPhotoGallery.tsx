        ...
        <div className="hidden md:grid grid-cols-2 h-full gap-5">
          ...
          >
            <Image
              ...
              className="img"
            />
            <div className="absolute cursor-pointer text-white inset-0 flex justify-center bg-[rgba(0,0,0,0,.5)] items-center">+ {remainingPhotosCount}</div>
          </div>}
        </div>
